...
export const Hero = ({ divRef }) => {
  return (
    <section
      className=" home w-full h-[calc(100svh-89px)] max-h-[900px] flex justify-center items-center flex-col relative"
      id="home"
      ref={divRef}
    >
      {/* <img
      ...
      <img
        ...
        height="1333"
      />
      <div className="absolute bottom-5 bg-white backdrop-blur-xl p-5 rounded-xl">
