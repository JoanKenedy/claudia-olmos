      ...
      <section className="px-4 w-full max-w-7xl grid grid-cols-1 place-content-center place-items-center my-10 md:grid-cols-2 md:gap-7">
        ...
        <article className="w-full text-center mb-3">
          ...
          <p className="text-lg text-start mt-4">
            En el consultorio de la Dra Claudia Olmos Miranda, nos enfocamos en
            brindar un servicio personalizado y de alta calidad. Con un firme
            compromiso hacia la ética, la honestidad y el bienestar de nuestros
            pacientes, trabajamos en un ambiente relajado y de confianza. Cada
            tratamiento se aborda de manera individual, proporcionando toda la
            información necesaria para que nuestros pacientes recuperen y
            mantengan su salud dental con seguridad y tranquilidad.
          </p>
